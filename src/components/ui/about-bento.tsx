      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 sm:gap-5">
          ...
          <Card className="md:col-span-2 md:row-span-2 bg-white dark:bg-[#0A0A0A] rounded-3xl p-7 sm:p-9 flex flex-col justify-between border border-slate-200/90 dark:border-zinc-800 relative overflow-hidden group shadow-2xs hover:shadow-md hover:border-slate-300 dark:hover:border-zinc-700 transition-all">
            {/* Non-looping Scroll-Reactive Star Background with Gemini Gradient Blend */}
            <motion.div
              style={{ rotate: starRotate }}
              className="absolute -bottom-16 -right-16 pointer-events-none origin-center"
            >
              <svg
                width="377"
                height="368"
              ...
              >
                <defs>
                  <linearGradient id="geminiStarBentoGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#4285F4" stopOpacity="0.32" />
                    <stop offset="25%" stopColor="#8B5CF6" stopOpacity="0.28" />
                  ...
                  <linearGradient id="geminiStarStrokeGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                    ...
                    <stop offset="35%" stopColor="#8B5CF6" stopOpacity="0.40" />
                    <stop offset="65%" stopColor="#EC4899" stopOpacity="0.35" />
                ...
                <path
                  ...
                  fill="url(#geminiStarBentoGradient)"
