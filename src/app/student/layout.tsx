...
export default function StudentLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 md:flex">
      <aside className="flex w-full shrink-0 flex-col justify-between border-b border-slate-200 bg-white shadow-sm md:min-h-screen md:w-64 md:border-b-0 md:border-r">
        <div>
